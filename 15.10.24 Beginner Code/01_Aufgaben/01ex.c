...
clang -std=c11 -g -Wall 01ex_test.c -o 01ex_test.o -lm && ./01ex_test.o
...
int simple_assignment(int a, int b)
{
    ...
    */
    ...
    Dort können Sie den Befehl `clang -std=c11 -g -Wall 01ex_test.c -o 01ex_test.o -lm && ./01ex_test.o`
    ...
    betreuten Arbeiten oder im Forum Hilfe suchen. Eine typische Fehlerquelle ist, dass der Kompiler `clang`
    eventuell nicht installiert ist. Überraschenderweise müssen Sie ihn in diesem Fall installieren.

    Die Konsolenausgabe kann etwas unübersichtlich sein. Der folgende Befehl führt ausschließlich die Tests für
    _diese_ Aufgabe durch: `clang -std=c11 -g -Wall 01ex_test.c -o 01ex_test.o -lm && ./01ex_test.o simple_assignment`.
